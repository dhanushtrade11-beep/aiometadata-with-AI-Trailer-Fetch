...
// --- Main Orchestrator ---
async function getMeta(type, language, stremioId, config = {}, userUUID, includeVideos = true, fetchTrailer = false) {
  try {
    // Validate inputs
    ...
    if (fetchTrailer && meta && (meta.type === 'movie' || meta.type === 'series')) {
      try {
        // Normalize country: meta.country can be a string like "India" or array of ISO codes
