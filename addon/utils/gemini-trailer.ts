...
const TELUGU_OFFICIAL = [
  ...
  'paramount pictures india','prime video southern languages','primetime media','prince pictures',
  ...
  'sony liv south','sony music dubbed telugu','sony pictures india','south indian hindi dubbed movies',
