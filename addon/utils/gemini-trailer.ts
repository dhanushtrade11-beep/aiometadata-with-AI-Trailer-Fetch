...
export async function fetchAccurateTrailer(params: TrailerRequest): Promise<string | null> {
  ...
  // We ask Gemini to act as a YouTube search engine to grab the precise 11-character ID
  const prompt = `
    Find the exact, official YouTube Video ID (11 characters) for this movie trailer.
